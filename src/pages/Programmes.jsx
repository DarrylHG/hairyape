      ...
      <section className="bg-sky-50 text-slate-900">
        <div className="container mx-auto px-4 py-16 md:py-20">
          <h1 className="text-3xl md:text-4xl font-extrabold mb-4">
            Kids Swimming Programmes: Ages 0.5–12 Years
          </h1>
            ...
            <div className="grid md:grid-cols-2 gap-8 lg:gap-10">
              ...
              <div className="bg-sky-50 rounded-3xl p-6 md:p-8 shadow-sm border border-sky-100">
                ...
                <div className="mt-6 text-slate-700">
                  ...
                  <p className="mb-5">
                    Recognises swimmers who have developed early water confidence and comfort,
                    and are ready to progress into structured learn-to-swim programmes.
                  </p>

                  <p className="font-semibold text-slate-800 mb-2">Award Criteria</p>
                  <ul className="space-y-2 text-slate-700 mb-5">
                    <li>• Blow bubbles with face comfortably in the water for at least 5 seconds</li>
                    <li>• Float independently (front or back) for at least 5 seconds</li>
                  </ul>

                  <p className="font-semibold text-slate-800 mb-2">What it signifies</p>
                  <ul className="space-y-2 text-slate-700">
                    <li>• Basic water confidence and comfort</li>
                    <li>• Willingness to place face in water</li>
                    <li>• Readiness to progress into ApeCore™ Learn-to-Swim</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="bg-sky-50 rounded-3xl p-6 md:p-8 shadow-sm border border-sky-100">
                ...
                <div className="mt-6 text-slate-700">
                  <p className="font-semibold text-slate-800 mb-2">Purpose</p>
                  <p className="mb-5">
                    Recognises swimmers who have developed stronger independence, control,
                    and foundational movement skills in the water, and are ready for
                  ...
                  <p className="font-semibold text-slate-800 mb-2">What it signifies</p>
                  <ul className="space-y-2 text-slate-700">
                    <li>• Strong foundation in water confidence and independence</li>
                    <li>• Consistent body control and propulsion skills</li>
                    <li>• Readiness to progress into SwimSafer® 2.0 Stage 1</li>
                  </ul>
